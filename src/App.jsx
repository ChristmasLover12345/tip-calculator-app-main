  ...
  return (
    <>
     <div className='bg-[#c5e4e7] w-screen h-screen flex flex-col items-center justify-center '>
      ...
      <div className='bg-white md:w-[90%] lg:w-[900px] h-auto rounded-2xl flex flex-col md:flex-row items-center p-10 justify-center'>
          ...
          <div className="w-full h-auto flex flex-row items-center bg-[#f4fafa] px-2 rounded-lg hover:border-4 hover:border-[#26c0ab] mb-2">
            ...
            <input onBlur={(e) => (e.target.value = "")}  onChange={(e) => setPeople(e.target.value)} type="text" placeholder="0" className=" text-end h-[60px] w-full text-[24px] font-bold bg-[#f4fafa] text-[#00494d] flex items-center justify-center" />
          </div>
        ...
        <div className="w-full h-auto md:h-full rounded-2xl flex flex-col items-center ms-2 bg-[#00494d]">
          ...
          <div className="w-[80%] flex justify-between items-center mt-12">
            ...
            <p className="text-[38px] text-[#26c0ab] font-medium">${tipAmount}</p>
          ...
          <p className="text-[38px] text-[#26c0ab] font-medium">${total}</p>

          </div>

          <div className="w-[80%] h-[60px] bg-[#26c0ab] rounded-2xl ">
